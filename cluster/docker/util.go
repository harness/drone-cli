...
func create(client dockerclient.Client, container *cluster.Container) error {
...
func start(client dockerclient.Client, ambassador, container *cluster.Container) error {
...
func stop(client dockerclient.Client, container *cluster.Container) error {
	client.StopContainer(container.ID, 5)
	client.KillContainer(container.ID, "SIGKILL")
	return nil
}

func remove(client dockerclient.Client, container *cluster.Container) error {
	return client.RemoveContainer(container.ID, true, false)
}

func state(client dockerclient.Client, container *cluster.Container) (*cluster.State, error) {
...
func logs(client dockerclient.Client, container *cluster.Container) (io.ReadCloser, error) {
...
func wait(client dockerclient.Client, container *cluster.Container) error {
